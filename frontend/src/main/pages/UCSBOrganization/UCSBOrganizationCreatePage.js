...
export default function UCSBOrganizationCreatePage({ storybook = false }) {
  ...
  const onSuccess = (organization) => {
    toast(
      `New UCSBOrganization Created - orgField: ${organization.orgField} orgTranslationShort: ${organization.orgTranslationShort} orgTranslation: ${organization.orgTranslation} inactive: ${organization.inactive}`,
    );
  };
