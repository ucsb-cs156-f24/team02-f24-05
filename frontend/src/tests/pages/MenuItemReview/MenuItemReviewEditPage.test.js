...
describe("MenuItemReviewEditPage tests", () => {
  describe("when the backend doesn't return data", () => {
    ...
    beforeEach(() => {
      ...
      axiosMock
        .onGet("/api/menu_item_review", { params: { id: 17 } })
        .timeout();
    });
  ...
  describe("tests where backend is working normally", () => {
    ...
    beforeEach(() => {
      ...
      axiosMock.onPut("/api/menu_item_review").reply(200, {
        id: "17",
        itemId: 2,
    ...
    test("Is populated with the data provided", async () => {
      ...
      expect(reviewerEmailField).toHaveValue("a@gmail.com");
      expect(commentsField).toHaveValue("normal");
    ...
    test("Changes when you click Update", async () => {
      ...
      fireEvent.change(reviewerEmailField, {
        target: { value: "b@gmail.com" },
      });
      fireEvent.change(starsField, { target: { value: "4" } });
      fireEvent.change(commentsField, { target: { value: "normal" } });
